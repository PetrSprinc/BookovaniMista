...
* začnu přidáním DB, připojím Docker, aby se data nemazala
* vytvořím strukturu DB podle náčrtu v příloze
* hrubě si rozvrhnu stránky a metody
* login pomocí vestavěné win domény
* jednotlivé stránky:
úvodní: 4 dlaždice
  * akce zabookovat místo, přidat nová rezervace
  * vypsat z DB datum_rezervace, misto.oznaceni, sekce.nazev pro aktuálního uživatele
  * vypsat z DB misto.oznaceni, zamestnanci.jmeno kde datum_rezervace = getDate() pro vybranou sekci, počítám s možností rezervace vůce dnů
